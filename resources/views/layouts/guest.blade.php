    ...
    <section class="container-fluid p-0" id="contenido">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow-sm">
            <section class="container-fluid">
                <h1 class="col-2 display-6"><a href="/" class="nav-link">InduTuc</a></h1>
                ...
                <section class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @if (Route::has('login'))
                            @auth
                                <li class="nav-item session ps-2 borde fs-6"><a href="{{route('profile.edit')}}" class="nav-link bi-person">Perfil</a>
