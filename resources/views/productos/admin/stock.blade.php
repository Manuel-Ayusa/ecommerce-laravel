...
@section('content')
    ...
    <a href="{{route('productos.administrar', $producto->categoria)}}" class="btn btn-white border mb-3">Volver atras</a>
        ...
        <table class="col-9 text-center table table-bordered table-striped table-hover">
            ...
            @foreach ($stock as $item)
                ...
                <tr>
                    ...
                    <td>{{$item->XL}}</td>
                    <td>{{$item->XXL}}</td>
                    <td><a href="{{route('productos.edit_stock', $item->id)}}" class="btn btn-warning">Modificar</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
    ...
    <section class="text-center mb-3">
        <a href="{{route('productos.create_stock', $producto->id)}}" class="btn btn-primary col-7">Agregar Stock</a>
    </section>
@endsection